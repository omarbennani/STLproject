	...
	public boolean equals(Object o) {
		if (o instanceof ParametreGenericiteImpl) {
			...
			if(this.name.equals(p.getName())) {
				// On pourrait ici vérifier si ils étendent les même objets mais cette méthode a été redéfinie
				// au départ pour pouvoir vérifier que dans une regle généricité, un identifiant de paramètres
				// ne soit pas défini deux fois. cad pour interdire Class Voiture <T, S, T> 2 X T
				return true;
			}
			else
				return false;
