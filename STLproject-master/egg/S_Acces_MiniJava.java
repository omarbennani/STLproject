...
int [] sync= new int[0];
  ...
  private void regle91() throws Exception {
	...
	S_Acces_MiniJava x_6 = new S_Acces_MiniJava(scanner,att_eval) ;
	//appel
if  (att_eval)	  action_auto_inh_91(x_3, x_6);
	x_2.analyser(LEX_MiniJava.token_crochet_ouvrant);
	x_3.analyser() ;
	x_4.analyser(LEX_MiniJava.token_crochet_fermant);
if  (att_eval)	  action_inh_91(x_3, x_6);
	x_6.analyser() ;
if  (att_eval)	  action_ast_91(x_3, x_6);
  }
...
private void action_ast_91(S_Expression_MiniJava x_3, S_Acces_MiniJava x_6) throws Exception {
try {
// instructions
this.att_ast=x_6.att_ast;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MiniJava", "#ast","Acces -> crochet_ouvrant Expression crochet_fermant #inh Acces1 #ast ;", e });
}
  }
private void action_inh_89(T_MiniJava x_3, S_AppelOuAcces_MiniJava x_5) throws Exception {
try {
// instructions
x_5.att_support=this.att_factory.createAcces(this.att_support, x_3.att_txt);
x_5.att_identificateur_type=null;
x_5.att_identificateur=x_3.att_txt;
...
private void action_auto_inh_91(S_Expression_MiniJava x_3, S_Acces_MiniJava x_6) throws Exception {
try {
// instructions
...
x_6.att_identificateur_type=this.att_identificateur_type;
x_6.att_identificateur=this.att_identificateur;
x_3.att_nomClasse=this.att_nomClasse;
x_6.att_nomClasse=this.att_nomClasse;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MiniJava", "#auto_inh","Acces -> crochet_ouvrant Expression crochet_fermant #inh Acces1 #ast ;", e });
}
  }
...
private void action_inh_91(S_Expression_MiniJava x_3, S_Acces_MiniJava x_6) throws Exception {
try {
// instructions
x_6.att_support=this.att_factory.createArrayAccess(this.att_support, x_3.att_ast);
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MiniJava", "#inh","Acces -> crochet_ouvrant Expression crochet_fermant #inh Acces1 #ast ;", e });
}
  }
